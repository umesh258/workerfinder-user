...
if($_POST)
{
	...
	$sq = mysqli_query($con,"select * from tbl_workermaster where worker_email='{$email}' ") or die("Error sq".mysqli_error($con));
    ...
    try {
        ...
        $mail->Body    = "Hey $email Your Password is {$fr['worker_password']}";
        $mail->AltBody = "Hey $email Your Password is {$fr['worker_password']}";
						...
						<div class="col-md-8">
							<div class="box">
								...
								<form method="POST" role="form">
                                    ...
                                    <button type="submit" onclick="window.location='workerlogin.php';" class="btn btn-primary btn-inline">Back</button>&nbsp; &nbsp; &nbsp;
								</form>
							</div>
						</div>
